...
const makeStation10Scene = () => {
  const stationSceneTimeline = new TimelineLite()
    .add([
      // show station
      TweenLite.fromTo('#station-10', 3000, { // show station duration
        // styles before
        x: '200%',
        display: 'none',
      }, {
      ...
      TweenLite.to('#station-10-scene', 6000, {
        ease: Linear.easeNone,
      }),
    ])
    ...
    // hide station scene
    .add([
      TweenLite.to('#station-10-scene', 1500, {
        x: '-300%',
        display: 'none',
        ease: Linear.easeNone,
      }),
