...
const makeStation4Scene = () => {
  const stationSceneTimeline = new TimelineLite()
    .add([
      ...
      // 1-2 card show
      TweenMax.fromTo('.station-4-scene-photo-1', 4000 * animKoef,
        {
          x: '-50vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-4-scene-photo-2', 4000 * animKoef,
        {
          x: '50vw',
          y: '120vh',
          ease: Linear.easeNone,
      ...
      // 3-4 card show
      TweenMax.fromTo('.station-4-scene-photo-3', 4000 * animKoef,
        {
          x: '100vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-4-scene-photo-4', 4000 * animKoef,
        {
          x: '100vw',
          y: '120vh',
          ease: Linear.easeNone,
      ...
      // 5-6 card show
      TweenMax.fromTo('.station-4-scene-photo-5', 4000 * animKoef,
        {
          x: '200vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-4-scene-photo-6', 4000 * animKoef,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
      ...
      // 7-8 card show
      TweenMax.fromTo('.station-4-scene-photo-7', 4000 * animKoef,
        {
          y: '-200vh',
          ease: Linear.easeNone,
          rotation: -320,
      ...
      TweenMax.fromTo('.station-4-scene-photo-8', 4000 * animKoef,
        {
          y: '200vh',
          ease: Linear.easeNone,
        },
      ...
      // 9-10 card show
      TweenMax.fromTo('.station-4-scene-photo-9', 4000 * animKoef,
        {
          x: '200vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-4-scene-photo-10', 4000 * animKoef,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
