...
const makeStation4Scene = () => {
  const stationSceneTimeline = new TimelineLite()
    .add([
      ...
      // 9-10 card show
      TweenLite.fromTo('.station-4-scene-photo-9', 2000,
        {
          x: '200vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenLite.fromTo('.station-4-scene-photo-10', 2000,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
      ...
      // 9-10 card hide
      TweenLite.to('.station-4-scene-photo-9', 2000, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 21000,
      }),
      TweenLite.to('.station-4-scene-photo-10', 2000, {
        x: '-150vw',
        display: 'none',
        ease: Linear.easeNone,
        delay: 21000,
