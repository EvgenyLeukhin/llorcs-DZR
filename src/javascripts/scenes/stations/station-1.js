...
const makeStation1Scene = () => {
  const stationSceneTimeline = new TimelineLite()
    .add([
      ...
      // 9-8 card show
      TweenMax.fromTo('.station-1-scene-photo-9', 2000 * animKoef,
        {
          x: '-50vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-1-scene-photo-8', 2000 * animKoef,
        {
          x: '50vw',
          y: '120vh',
          ease: Linear.easeNone,
      ...
      // 4-6 card show
      TweenMax.fromTo('.station-1-scene-photo-4', 2000 * animKoef,
        {
          x: '100vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-1-scene-photo-6', 2000 * animKoef,
        {
          x: '100vw',
          y: '120vh',
          ease: Linear.easeNone,
      ...
      // 1-2 card show
      TweenMax.fromTo('.station-1-scene-photo-1', 2000 * animKoef,
        {
          x: '200vw',
          y: '-120vh',
          ease: Linear.easeNone,
      ...
      TweenMax.fromTo('.station-1-scene-photo-2', 2000 * animKoef,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
      ...
      // 5-3 card show
      TweenMax.fromTo('.station-1-scene-photo-5', 2000 * animKoef,
        {
          y: '200vh',
          ease: Linear.easeNone,
          rotation: -320,
      ...
      TweenMax.fromTo('.station-1-scene-photo-3', 2000 * animKoef,
        {
          y: '-200vh',
          ease: Linear.easeNone,
          rotation: -320,
      ...
      // 7 card show
      TweenMax.fromTo('.station-1-scene-photo-7', 2000 * animKoef,
        {
          x: '-100vw',
          y: '200vh',
          ease: Linear.easeNone,
